...
if (isset($_POST['update_general'])) {
    ...
    $conn->query("UPDATE settings SET setting_value = '" . $conn->real_escape_string($copyright_text) . "' WHERE setting_key = 'copyright_text'");
    $conn->query("UPDATE settings SET setting_value = '" . $conn->real_escape_string($whatsapp_number) . "' WHERE setting_key = 'whatsapp_number'");
    ...
    <main class="content">
        ...
        <div class="card">
            <form method="post">
                ...
                <div class="input-group">
                    <label for="whatsapp_number">WhatsApp Number (with country code, e.g., 8801234567890)</label>
        ...
        <div class="card">
            ...
            <form method="post">
                ...
                <div class="input-group">
                    <!-- লিঙ্কে একটি নতুন ক্লাস যোগ করা হয়েছে -->
                    <label>Font Awesome Icon Class <a href="https://fontawesome.com/v5/search?m=free" target="_blank" class="icon-finder-btn">Find an icon</a></label>
                    <input type="text" name="icon_class" placeholder="Example: fas fa-envelope" required>
                </div>
                 <div class="input-group">
                    <label>Action Link (The URL that opens on click)</label>
                    <input type="text" name="link_url" placeholder="Example: mailto:info@example.com OR https://facebook.com/yourpage" required>
                </div>
                 <div class="input-group">
                    <label>Display Text (The text shown on the website)</label>
                    <input type="text" name="display_text" placeholder="Example: info@example.com OR Your Page Name" required>
                </div>
